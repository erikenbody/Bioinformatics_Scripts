...
interproscan.sh -i $MAKER_HOME/ WSFW_assembly_maker2.all.maker.proteins.fasta -o wsfw.iprscan -t p -dp -pa -appl PfamA,ProDom,SuperFamily,PIRSF --goterms --iprlookup
