...
rsem-calculate-expression --bowtie2 --num-threads 20 --strand-specific --paired-end  $FQ_DIR/${READ}_clp.fq.1.gz  $FQ_DIR/${READ}_clp.fq.2.gz  $TRANS_DATA/transcripts  ${READ}_RSEM_bowtie2
