...
#SBATCH -J fq_bam2             # Job name
#SBATCH --mem=64000
#SBATCH --cpus-per-task=20

#FOR RUNNING LANE 2 RESULTS

export PATH=/usr/lib/jvm/jre-1.8.0-openjdk.x86_64/bin:$PATH
export JAVA_HOME=/usr/lib/jvm/java-1.8.0-openjdk.x86_64/jre
module load bwa/0.7.15

FASTQDIR=/home/eenbody/Enbody_WD/WSFW_DDIG/Raw_WSFW_WGS/WGS_Lane2/Lane7.indexlength_6/Fastq
WORK_D=/home/eenbody/Enbody_WD/WSFW_DDIG/reseq_WD/Preprocessing/2fastq_to_bam
...
java -Xmx60g -XX:ParallelGCThreads=20 -jar ~/BI_software/picard.jar FastqToSam \
...
java -Xmx60g -XX:ParallelGCThreads=20 -jar ~/BI_software/picard.jar MarkIlluminaAdapters \
...
java -Xmx60g -XX:ParallelGCThreads=20 -jar ~/BI_software/picard.jar SamToFastq \
	I=${SAMPLE}_${SAMPLEREPNUM}_markilluminaadapters.bam \
	FASTQ=/dev/stdout \
	CLIPPING_ATTRIBUTE=XT CLIPPING_ACTION=2 INTERLEAVE=true NON_PF=true \
	TMP_DIR=./tmp | \
bwa mem -M -t 20 -p $REF/WSFW_ref_noIUB.fasta /dev/stdin | \
java -Xmx60g -XX:ParallelGCThreads=20 -jar ~/BI_software/picard.jar MergeBamAlignment \
