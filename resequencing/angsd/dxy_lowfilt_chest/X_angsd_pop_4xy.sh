...
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -e perpopangsd2.err            # File to which STDERR will be written
#SBATCH -o perpopangsd2.out           # File to which STDOUT will be written
#SBATCH -J perpopangsd2           # Job name
...
do
 ...
 angsd -bam $BAMLIST -ref $REFGENOME -anc $ANC -rf $REGIONS -uniqueOnly 1 -P 20 -sites lorentzi_moretoni_NH_cut.mafs \
