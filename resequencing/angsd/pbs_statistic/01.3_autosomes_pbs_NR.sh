...
realSFS fst index $SAMPLEDIR/Results/${POP2}.${CHR}_scaffolds.ref.saf.idx $SAMPLEDIR/Results/${POP3}.${CHR}_scaffolds.ref.saf.idx $SAMPLEDIR/Results/${POP4}.${CHR}_scaffolds.ref.saf.idx -sfs $SAMPLEDIR/Results/${POP2}_${POP3}.sfs -sfs $SAMPLEDIR/Results/${POP2}_${POP4}.sfs -sfs $SAMPLEDIR/Results/${POP3}_${POP4}.sfs -fstout ${POP2}_${POP3}_${POP4}_${CHR}_${DESCRIPTION} -whichFST 0

#quotes neccessary because of special character ">"
realSFS fst ${POP2}_${POP3}_${POP4}_${CHR}_${DESCRIPTION}.fst.idx -win 50000 -step 25000 -whichFST 0 > ${POP2}_${POP3}_${POP4}_${CHR}_${DESCRIPTION}_50000-Win.fst.txt
