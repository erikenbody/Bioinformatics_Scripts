...
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -e angsd_high_filt4.err            # File to which STDERR will be written
#SBATCH -o angsd_high_filt4.out           # File to which STDOUT will be written
...
WORK_D=/home/eenbody/reseq_WD/angsd/fst_angsd/auto/high_filter_NR_depth
