...
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -e angsd_sfs_a_%A_%a.err            # File to which STDERR will be written
#SBATCH -o angsd_sfs_a_%A_%a.out           # File to which STDOUT will be written
...
#mkdir Results #must exist in advance
...
#realSFS fst stats2 Results/${POP1}_${POP2}.pbs.fst.idx -win 25000 -step 5000 -whichFST 0 > Results/${POP1}_${POP2}_a.pbs.txt
