...
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -e angsd_sfs_c.err            # File to which STDERR will be written
#SBATCH -o angsd_sfs_c.out           # File to which STDOUT will be written
#SBATCH -J angsd_sfs_c           # Job name
