...
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -e angsd_sfs_b.err            # File to which STDERR will be written
#SBATCH -o angsd_sfs_b.out           # File to which STDOUT will be written
#SBATCH -J angsd_sfs_b           # Job name
