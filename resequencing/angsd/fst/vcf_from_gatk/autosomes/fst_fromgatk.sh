...
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -e gatk_angsd_a.err            # File to which STDERR will be written
#SBATCH -o gatk_angsd_a.out           # File to which STDOUT will be written
#SBATCH -J gatk_angsd_a           # Job name
...
WORK_D=/home/eenbody/reseq_WD/angsd/fst_angsd/vcf_from_gatk
