...
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -e nocov_NR_bycolor.err            # File to which STDERR will be written
#SBATCH -o nocov_NR_bycolor.out           # File to which STDOUT will be written
...
parallel --link /home/eenbody/BI_software/angsd0.920_tar_install/angsd/misc/realSFS fst index $SAMPLEDIR/Results/{1}.${CHR}_scaffolds.ref.saf.idx $SAMPLEDIR/Results/{2}.${CHR}_scaffolds.ref.saf.idx -sfs $SAMPLEDIR/Results/{1}_{2}.sfs -fstout {1}_{2}_${CHR}_${DESCRIPTION} -whichFST 0 ::: $POP1 $POP3 ::: $POP2 $POP4
