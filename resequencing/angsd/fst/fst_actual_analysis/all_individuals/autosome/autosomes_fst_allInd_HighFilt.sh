...
#all or NR
SUBSET=all
DESCRIPTION=All-Ind-HigherFilt
...
parallel --link realSFS fst index $SAMPLEDIR/Results/{1}.${CHR}_scaffolds_${EXT2}.ref.saf.idx $SAMPLEDIR/Results/{2}.${CHR}_scaffolds_${EXT2}.ref.saf.idx -sfs $SAMPLEDIR/Results/{1}_{2}_${EXT2}.sfs -fstout {1}_{2}_${CHR}_${DESCRIPTION} -whichFST 0 ::: $POP1 $POP1 $POP1 $POP3 $POP2 $POP2 ::: $POP2 $POP3 $POP4 $POP4 $POP3 $POP4
