...
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -e angsd_low_filtZ.err            # File to which STDERR will be written
#SBATCH -o angsd_low_filtZ.out           # File to which STDOUT will be written
#SBATCH -J angsd_low_filtZ          # Job name
...
WORK_D=/home/eenbody/reseq_WD/angsd/fst_angsd/zchr/low_filter_NR
