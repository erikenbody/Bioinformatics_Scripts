...
#SBATCH -e ./logs/fstvcf.z1.err            # File to which STDERR will be written
#SBATCH -o ./logs/fstvcf.z1.out           # File to which STDOUT will be written
...
EXT=WSFW_passed_CovFil_2_320.vcf
#all or NR
SUBSET=all
